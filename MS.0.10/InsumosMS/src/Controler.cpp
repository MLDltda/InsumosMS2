...
default:
    ...
    std::cout << "Insumo cadastrado com sucesso." << std::endl;
...
void Controler::setDadosVacina(std::string name){
    ...
    int quant;
    float value;
    std::string date, Fabricant, type;
    int doses, inter;
    //ate aqui
...
default:
    ...
    pers.salvarInsumosVacina(1, name, quant, value, date, Fabricant, type, doses, inter, locais[0].getNomeLocal());
...
default:
    ...
    pers.salvarInsumosMedicamento(2, name, quant, value, date, Fabricant, dose, admin, dispo, locais[0].getNomeLocal());
...
default:
    ...
    pers.salvarInsumosEPI(3, name, quant, value, date, Fabricant, type, desc, locais[0].getNomeLocal());
...
void Controler::distribuiInsumo(int escolha){
    ...
    if(total){
        ...
        std::cout << "Insumo enviado com sucesso." << std::endl;
        std::cout << "Aperte enter para continuar." << std::endl;
        getchar();
        return;
